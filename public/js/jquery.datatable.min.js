        ...
        var j = function(e) {
            ...
            function za(a) {
                var b = a.oPreviousSearch,
                    ...
                    c = -1 !== c.indexOf("_INPUT_") ? c.replace("_INPUT_", '<input type="text"  />') : "" === c ? '<input type="text"  placeholder="Search" class="search_w" />' : c + ' <input type="text"/> ',
            ...
            function ya(a) {
                ...
                var b = '<select size="1" class="search_w"' + ('name="' + a.sTableId + '_length"') + ">",
                    c, d, i = a.aLengthMenu;
